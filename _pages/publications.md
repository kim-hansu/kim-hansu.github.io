...
13. Kim S, Kim H,* Kang N, Lee TH* (2025) Projected variable three-term conjugate gradient algorithm for enhancing generalization performance in deep neural network training. [*Neurocomputing*](https://www.sciencedirect.com/journal/neurocomputing). [https://doi.org/10.1016/j.neucom.2025.131568](https://doi.org/10.1016/j.neucom.2025.131568)
...
6. (Accepted) Kim H* (2025) Analysis of research trends in topology optimization and generative AI for design for additive manufacturing. [*Transactions of the Korean Society of Mechanical Engineers A*](http://journal.ksme.or.kr/).
